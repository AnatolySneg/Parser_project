...
class CurrencyTransformation(BankTransformation):
    ...
    def _get_ordered_currency_data(self):
        ...
        for bank in self.unsorted_currency:
            ...
            alpha = dict(sorted(currency_data.items()))
            ordered_data.update({bank: alpha})
        return ordered_data

    def __init__(self, data_source):
        self.data_source = data_source
        self.unsorted_currency = BankTransformation(self.data_source).valid_result_data
...
if __name__ == "__main__":
    ...
    income_data = {
        ...
        {'r030': 376, 'txt': 'Новий ізраїльський шекель', 'rate': 9.3571, 'cc': 'ILS', 'exchangedate': '09.11.2023'},
        ...
        {'r030': 934, 'txt': 'Туркменський новий манат', 'rate': 10.3661, 'cc': 'TMT', 'exchangedate': '09.11.2023'},
    ...
    instance = CurrencyTransformation(income_data)
